	  ...
	  <tr>
		...
		<table border="0" cellpadding="3" cellspacing="0" width="60%" style="border:1px solid #CCCCCC">
		 ...
		 <?php } ?>
		  ...
		  <tr>
			<td align="right" class="ltext">Gross Salary On March<span style="color:#FF0000">*</span></td>
			<td align="left">&nbsp;
				  <input type="text" name="grossmarch" class="inputbox" value="<?php echo $grossmarch; ?>" />        </td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			<td height="198"><table border="0" bordercolor="#CCCCCC" cellpadding="2" cellspacing="1" width="100%"  >
			  ...
			  <tr>
				...
				<td align="left"  style="height:30px;color:#313131;" ><span style="font-size:12px;"> 10,000/- </span> </td>
