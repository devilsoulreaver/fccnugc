			...
			<td align="center">
				<table cellpadding="0" cellspacing="0" border="0" width="100%" class="maintable">
					...
					<tr>
						...
						<td align="left" width="60%" class="b"><font size="1"><b><?php echo $empdetails['empname']."<br/>";  echo  $empdetails['address']; ?></b></font>
						</td>
					</tr>
			...
			<td >
				<table cellpadding="0" cellspacing="0" border="0"  width="100%">
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:1px solid #333333">
								  <tr >
									  ...
									  <tr>
										...
										<td align="left" class="br" ><span style="font-size:12px;"> 10,000/- </span> </td>
					...
					<tr style="height:30px;">
						...
						<td ><font size="2">Rs.&nbsp;<?php echo round($balance_tax_payable); ?></font></td>
					</tr>
					<tr style="height:30px;">
					...
					<tr style="height:30px;">
						...
						<td ><font size="2">Rs.&nbsp;<?php echo (int)$tax_payble_refundable; ?></font></td>
					</tr>
					<tr style="height:30px;">
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:1px solid #333333">
								  ...
								  <tr >
								   ...
								   <tr >
									...
									<td align="left"  class="br" ><?php echo $tax_march; ?></td>
									<td align="left"  class="br" ><span style="font-size:12px;"> &nbsp; </span> </td>
									<td align="left" class="b" >&nbsp;</td>
								  </tr>
							</table>						</td>
