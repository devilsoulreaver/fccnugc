...
#echo $pfno;
 ...
 ?>
 <html><title>INDBILL MASTER DETAILS</title>
  <br>
 <h1>INDBILL MASTER VIEW</h1>
 ...
 <?php
   ...
   $sql="select ROW_NUMBER() OVER(ORDER BY (SELECT 1)) AS \"SL NO\", empid as \"PF NO\", empname(empid)\"NAME\", gross \"GROSS\",
    ofdate AS \"SAL DATE\", ind_bill_no as \"INDBILL NO\",  remarks as \"REMARKS\"
   from ind_bills_master join paybill using(ind_bill_no) where remarks IN('PRARR-2019','PRA_SUARR_2019')and empid = '{$pfno}'  ";
