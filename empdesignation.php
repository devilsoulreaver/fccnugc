...
{
$head="<table align=\"center\" border=\"0\" width=\"50%\"><tr bgcolor=#abcdef><td align=\"center\"><h1>Promotion Details Of Employee</h1></td></tr></table><br>";
print $head;
$str="<table align=\"center\" border=\"0\" width=\"50%\">";
...
print $str;
print $sql;      
$sql2="select a.empid,b.name,a.wefdate,a.enddate,a.sanc_date from emp_desig a,desig_master b where a.desigid=b.id and a.empid='$empid' and  empcategoryid(empid)<>'G' order by 3"; 
...
{
$str="<table align=\"center\" border=\"0\" width=\"80%\"><tr bgcolor=\"cyan\"><th >Emp Id<th>Designation<th>WEF Date<th>End date<th>Sanc Date</tr>";
