...
{
$head="<table align=\"center\" border=\"0\" width=\"50%\"><tr bgcolor=#abcdef><td align=\"center\"><h1>DA / INCREMENT ARREAR TO PF DETAILS</h1></td></tr></table><br>";
print $head;
$str="<table align=\"center\" border=\"0\" width=\"25%\">";
...
$sql2= "select empid,ofdate,amount,percentage,remarks from da_arr_to_pf where empid='$empid' order by 2";
