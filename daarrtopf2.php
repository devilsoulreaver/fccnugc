...
{
$head="<table align=\"center\" border=\"0\" width=\"50%\"><tr bgcolor=#abcdef><td align=\"center\"><h1>DA ARREAR TO CASH DETAILS</h1></td></tr></table><br>";
print $head;
$str="<table align=\"center\" border=\"0\" width=\"25%\">";
...
$sql2= "select * from da_arr_to_cash where empid='$empid' order by 2";
...
{
$str="<table align=\"center\" border=\"0\" width=\"80%\"><tr bgcolor=\"cyan\"> <th>Emp Id<th>WEF Date<th>Amount</th><th>percentage<th><th>Remarks<th></tr>";
