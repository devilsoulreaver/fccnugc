...
{
$head="<table align=\"center\" border=\"0\" width=\"50%\"><tr bgcolor=#abcdef><td align=\"center\"><h1>BP Increment Details Of Employee</h1></td></tr></table><br>";
print $head;
$str="<table align=\"center\" border=\"0\" width=\"50%\">";
...
$sql2="select a.empid,a.cur_bp,a.wefdate,a.sanc_date,b.ordno,b.orddate from emp_bp_incr as a inner join bp_incr_log as b on  a.empid='$empid' and  empcategoryid(a.empid)<>'G'  and a.empid=b.empid and a.refid=b.refid and a.wefdate=b.wefdate order by 3";
...
{
$str="<table align=\"center\" border=\"0\" width=\"80%\"><tr bgcolor=\"cyan\"> <th>Emp Id<th>Basic<th>WEF Date<th>Sanc Date</th><th>OrderNo<th>OrderDate<th></tr>";
